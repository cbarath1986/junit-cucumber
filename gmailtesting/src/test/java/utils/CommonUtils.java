...
public abstract class CommonUtils {
    ...
    public void navigateBack() throws Exception {
        try {
            ...
            throw new Exception("Could not navigate back to previous page.");
        }
    }
    ...
    public String getPageTitle() throws Exception {
        try {
            ...
            throw new Exception(String.format("Current page title is: %s", _driver.getTitle()));
        }
    }
    ...
    public String getCurrentURL() throws Exception {
        try {
            ...
            throw new Exception(String.format("Current URL is: %s", _driver.getCurrentUrl()));
        }
    }
    ...
    public String getElementText(By selector) {
        ...
        try {
            return _driver.findElement(selector).getText().trim();
        } catch (Exception e) {
            System.out.println(String.format("Element %s does not exist - proceeding", selector));
        }
        return null;
    ...
    public List<String> getListOfElementTexts(By selector) throws Exception {
...
//        } catch (Exception e) {
//            throw new Exception(String.format("The following element is not clickable: [%s]", element.toString()));
//        }
//    }
    ...
    public void waitForElementToBeClickable(By selector) throws Exception {
        try {
            wait = new WebDriverWait(_driver, timeout);
            wait.until(ExpectedConditions.elementToBeClickable(selector));
        } catch (Exception e) {
            throw new Exception("The following element is not clickable: " + selector);
        }
    }
    ...
    public void selectIfOptionTextContains(By selector, String searchCriteria) throws Exception {
        ...
        if (options == null) {
            throw new Exception("Options for the dropdown list cannot be found.");
        }
    ...
    public void selectIfOptionTextEquals(By selector, String searchCriteria) throws Exception {
    ...
    public List<String> getDropdownValues(By selector) throws Exception {
